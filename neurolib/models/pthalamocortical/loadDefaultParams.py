...
def loadDefaultParams(Cmat=None, Dmat=None, lookupTableFileName=None, seed=None, n_nodes_ctx=None, n_nodes_thal=None):
    ...
    params.model = "pthalamocortical"
    params.name = "pthalamocortical"
    params.description = "Parallel thalamocortical model with 80 cortical nodes and 2 thalamic nodes."
